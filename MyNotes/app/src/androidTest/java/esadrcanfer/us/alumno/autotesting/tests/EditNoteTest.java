...
public class EditNoteTest {
    ...
    public void editNoteTest2() {
        ...
        ViewInteraction appCompatEditText = onView(
                allOf(withId(R.id.editText1), withText("My first note"),
                        childAtPosition(
                                ...
                                1),
                        isDisplayed()));
        appCompatEditText.perform(replaceText("Prueba cambio de texto"));

        ViewInteraction appCompatEditText2 = onView(
                allOf(withId(R.id.editText1), withText("Prueba cambio de texto"),
                        childAtPosition(
                                allOf(withId(R.id.linearLayout1),
                                        childAtPosition(
                                                withClassName(is("android.widget.RelativeLayout")),
