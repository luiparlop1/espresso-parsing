...
public class NotaSinAsercion {

    @Rule
    public ActivityTestRule<MainActivity> mActivityTestRule = new ActivityTestRule<>(MainActivity.class);

    @Test
    public void notaSinAsercion() {
                        ...
                        childAtPosition(
                                allOf(withId(R.id.linearLayout1),
                                        childAtPosition(
                                                ...
                                                4)),
                                1)));
        appCompatEditText.perform(scrollTo(), replaceText("Nota de prueba"), closeSoftKeyboard());
        ...
        ViewInteraction switch_ = onView(
                allOf(withId(R.id.switch1), withText("Alarma"),
                        childAtPosition(
                                childAtPosition(
                                        withClassName(is("android.widget.LinearLayout")),
                                        0),
